...
//	@GetMapping("/bev_order/{id}")
//	public ResponseEntity<BevOrder> getBeverage_order_by_id(@PathVariable Long id) {
//			try {
//				BevOrder bevOrder=bevOrderService.get(id);
//				return ResponseEntity.ok(bevOrder);
//			}catch(Exception e) {
//				throw e;
//			}
//}
